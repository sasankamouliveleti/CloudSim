...
/*This is a simulation of Saas datacenter, its behavior while allocating resources and handling cloudlets*/
object SaasSimulation {
  val logger: Logger = CreateLogger(classOf[SaasSimulation]) /* Define the logger*/
